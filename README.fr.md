...
<p align="center">
  <img src="docs/graph-preview.png" alt="CodeGraph Explorer appliqué à son propre dépôt — deux clusters force-directed (le script builder et la suite de tests), nœuds fonction en bleu, fichiers en gris, entrypoints en vert" width="680">
  <br>
  <em>CodeGraph appliqué à son propre code source — <code>graph.html</code>, la vue interactive auto-contenue (<a href="docs/graph-preview.svg">SVG</a>).</em>
</p>
...
├── README.md                        ← version anglaise (affichée par défaut sur GitHub)
